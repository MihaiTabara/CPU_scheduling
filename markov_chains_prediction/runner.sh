...
do
    ...
    # Compute error
	python util.py $MYPATH/192.168.6.4$I/stat_cpu 30 192.168.6.4$I/mc_prediction_cpu_30% > 192.168.6.4$I/mc_error_cpu_30%
	python util.py $MYPATH/192.168.6.4$I/stat_cpu 50 192.168.6.4$I/mc_prediction_cpu_50% > 192.168.6.4$I/mc_error_cpu_50%
	python util.py $MYPATH/192.168.6.4$I/stat_mem 30 192.168.6.4$I/mc_prediction_mem_30% > 192.168.6.4$I/mc_error_mem_30%
	python util.py $MYPATH/192.168.6.4$I/stat_mem 50 192.168.6.4$I/mc_prediction_mem_50% > 192.168.6.4$I/mc_error_mem_50%
